...
const cards = [
  ...
  },
  {
    ...
    heading3: 'Petro',
    list1: ['Back End Dev', '2022'],
    paragraph: 'Bookstore: A React-based web application for managing a virtual library. Users can view, add, and remove books, with the interface designed according to Zeplin specifications.',
    desktopImage: './images/Books.PNG',
    list2: ['html5', 'css3', 'react'],
    cardButton: 'See Project',
    cardButton1: 'https://unrivaled-sprinkles-46a634.netlify.app/',
    cardButton2: 'https://github.com/Loltolo-Lesapiti/Bookstore',
  },
  {
    class: 'flex reverse',
    header2: 'Budget App',
  ...
  },
  {
    ...
    heading3: 'Petro',
    list1: ['Full Stack Dev', '2021'],
    paragraph: 'The leaderboard website displays scores submitted by different players. It also allows you to submit your score.',
    desktopImage: './images/leaderboard.PNG',
    list2: ['HTML5', 'CSS3', 'JavaScript ES6', 'Bootstrap5'],
    cardButton: 'See Project',
    cardButton1: 'https://lucky-cobbler-09613f.netlify.app/',
    cardButton2: 'https://github.com/Loltolo-Lesapiti/Leaderboard',
  },
  {
    class: 'flex',
    header2: 'Awesome Books',
    heading3: 'Petro',
    list1: ['Full Stack Dev', '2021'],
    paragraph: 'Awesome Books: A simple web application for managing a book list. Users can view, add, and remove books, with basic navigation between list, add book, and contact sections.',
  ...
  {
    class: 'flex reverse',
    header2: 'Todo List App',
    heading3: 'Petro',
    list1: ['Full Stack Dev', '2021'],
    paragraph: 'Todo List App: A simple, user-friendly application for managing daily tasks. Users can add, edit, and delete items, mark tasks as complete, and organize their to-do list efficiently.',
    desktopImage: './images/todo.jpg',
    list2: ['HTML5', 'CSS3', 'JavaScript ES6', 'Webpack'],
    cardButton: 'See Project',
    cardButton1: 'https://github.com/Loltolo-Lesapiti/To-do-App',
    cardButton2: 'https://github.com/Loltolo-Lesapiti/To-do-App',
  }
];
